...
## CHECKPOINT_14_SEG001_GMAIL_PUBLISHED
...
COMPLETE_VALIDATOR_RUN_1=FUNCTIONAL_PASS complete-crm-20260730-090155.json 620.955s
COMPLETE_VALIDATOR_RUN_2=FUNCTIONAL_PASS complete-crm-20260730-091224.json 640.545s
IMPLEMENTATION_COMMIT=df2c79a77e27203f7eb63325f3e526cf38d1820a
VALIDATED_COMMIT=d6bfe64283cd3bab8dce441e4b01e348f9a55d5e
PUSH=EXECUTED_PASS 9995b3e..d6bfe64
REMOTE_VERIFICATION=HEAD_ORIGIN_MAIN_LS_REMOTE_EQUAL LEFT_RIGHT_0_0
CI=EXECUTED_PASS run_30530515993 22_OF_22
```

La extensión reutiliza V10–V12, agrega V14, no crea otra cola y conserva los
defaults fail-closed. Las dos corridas limpias pasaron y el cierre remoto fue
verificado después del push fast-forward.
...
## CHECKPOINT_12_REMOTE_MAIN_AND_CI

```text
DOCUMENTATION_COMMIT=1c86ac2202a0efc55b49e21132f505c934467e4f
FAILED_CI_RUN=29950739875
FAILED_CI_RESULT=EXECUTED_FAIL
FAILED_CI_CAUSES=MVNW_NOT_EXECUTABLE; DOCKER_IMAGE_REFERENCE_MISMATCH
CI_FIX_COMMIT=b904ff37e506f058dab351c2b941e13ee4ed9981
PUBLISHED_BRANCH=main
PUBLISHED_REMOTE=origin/main
FINAL_CI_RUN=29951586239
FINAL_CI_EVENT=push
FINAL_CI_STATUS=completed
FINAL_CI_CONCLUSION=success
FINAL_CI_JOBS=22/22
FINAL_CI_FAILED=0
FINAL_CI_CANCELLED=0
FINAL_CI_SKIPPED=0
NODE_ACTION_WARNING=actions_v4_node20_forced_to_node24
WORKTREE_AFTER=CLEAN
